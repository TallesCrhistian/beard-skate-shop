...
export default function Home() {
 ...
 const stringList = [<Image   src={ImageLarga} alt="Test"/>, <Image src={ImageLarga} alt="Test"/>]
  ...
  return (
    <main className="bg-primary-black">
      <section>
        ...
        <div className="flex mb-6 ml-6 p-3">
          <Image src={FreeShippingLogo} alt="FreeShippingLogo" className="w-10 h-10 mt-3" />
          <p className="text-white ml-6 w-3/4 font-inter text-start"><span className="font-bold text-lg">Frete Grátis</span> nas compras acima de R$189,90 para a regiões Sul & Sudeste e acima de R$300,00 para as demais.</p>
        </div>
        <div className="flex mb-6 ml-6">
          <Image src={HotPriceLogo} alt="HotPriceLogo" className="w-10 h-10" />
          <p className="text-white ml-6 w-3/4 font-inter text-start">5% de <span className="font-bold text-lg">DESCONTO</span> nas compras a vista para as compras acima de R$ 199,99!</p>
        </div>
        <div className="flex ml-6">
          <Image src={CreditCardLogo} alt="CreditCardLogo font-inter" className="w-10 h-10" />
          <p className="text-white ml-6 w-4/5 text-start">Parcelamento Mínimo de  R$80,00 | Até 12x <span className="font-bold text-lg">SEM JUROS</span>!</p>
        </div>
      </section>
      <section className="mt-6">       
        <h1 className="text-white text-center font-black font-inter text-3xl mb-3 relative">
          Ofertas Especiais
          <span className="block mx-auto  mt-1 w-4/5 border-b-2 border-white"></span>
        </h1>
        <div className="flex">
