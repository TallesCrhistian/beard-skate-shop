...
const CardProduct: React.FC<CardProductType> = ({ conditition, imageAlt, imageSrc, name, price }) => {
    ...
    return (
        <div className="w-48 sm:w-60 flex flex-col justify-center items-center text-center p-3">
            <Link href={productRoute} onClick={handleClick} className="p-2 flex justify-center border w-full items-center">
            ...
            <Link href={productRoute} className="bg-primary-green flex w-40 h-12 text-center justify-center items-center cursor-pointer">
